...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FileUpload.uploaded_file'
        db.delete_column(u'fileupload_fileupload', 'uploaded_file')


    def backwards(self, orm):
        # Adding field 'FileUpload.uploaded_file'
        db.add_column(u'fileupload_fileupload', 'uploaded_file',
